...
node <repo>/scripts/updater-selftest.mjs                    # ALL PASS (45 เคส) — รันจาก repo checkout เท่านั้น
```
