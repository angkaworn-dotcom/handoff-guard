<!--
  คำแปลอ้างอิงเท่านั้น ไฟล์ที่ Claude Code โหลดจริงคือ
  commands/handoff-guard-max.md (ติดตั้งที่ ~/.claude/commands/) ไฟล์ภาษาไทยนี้
  บันทึกพฤติกรรมเดียวกันไว้อ้างอิง แต่ไม่ถูกติดตั้งเป็นคำสั่งเอง
  (ถ้าติดตั้งด้วยจะกลายเป็นคำสั่งซ้ำซ้อน "handoff-guard-max.th")
-->

# /handoff-guard-max (ฉบับอ้างอิงภาษาไทย)

> [English (functional command)](handoff-guard-max.md)
