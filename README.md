...
มันรู้เพดานของแต่ละ model เอง (Fable/Opus 256k, Sonnet/Haiku 200k, โหมด long-context `[1m]` 1M) และถ้า session โดน compact ไปแล้วโตกลับมาใกล้เต็มอีก มันจะเตือนซ้ำได้
...
```bash
node ~/.claude/skills/handoff-guard/scripts/selftest.mjs   # ต้องขึ้น ALL PASS (36 เคส)
```
...
|-----|-------------|----------|
| `HANDOFF_GUARD_MAX` | auto ตาม model | เพดาน context — Fable/Opus 256k, Sonnet/Haiku/ไม่รู้จัก 200k, `[1m]` 1M |
