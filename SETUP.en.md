...
| Change the context ceiling (display) (manual/override) | env `HANDOFF_GUARD_MAX` (default = auto-detect per model) — beyond this, context quality starts degrading · T1/T2 are automatically recomputed as % of this value (file-pinned t1/t2 are skipped — they were derived from the old max) |
