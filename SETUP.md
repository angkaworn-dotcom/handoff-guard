...
```
node ~/.claude/skills/handoff-guard/scripts/selftest.mjs    # ALL PASS (47 เคส)
node <repo>/scripts/updater-selftest.mjs                    # ALL PASS (51 เคส) — รันจาก repo checkout เท่านั้น
```
